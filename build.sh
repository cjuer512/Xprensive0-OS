...
# 只编译生成调试文件
echo "=== 编译带调试信息的文件 ==="
rm -f hd.raw *.bin *.elf *.o *.gdb *.map *.log
...
echo "=== 链接生成调试ELF ==="
ld -nostdlib -Ttext=0x10200 \
    -g \
    -o xprensive-debug.elf \
    loader64.o keyboard.o print.o driverp.o harddisk.o graphicscard.o
